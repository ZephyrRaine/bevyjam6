...
impl FromWorld for SyncTracks {
    fn from_world(_world: &mut World) -> Self {
        Self {
            ...
            timer_tracks: [
                Timer::from_seconds(60.0 / (90.0 / 8.0), TimerMode::Repeating),
                Timer::from_seconds(60.0 / (90.0 * 1.5), TimerMode::Repeating),
                Timer::from_seconds(60.0 / (90.0 * 1.0), TimerMode::Repeating),
            ],
        }
    }
}
...
pub(super) fn plugin(app: &mut App) {
    ...
    app.add_systems(FixedUpdate, update_timers);
}
